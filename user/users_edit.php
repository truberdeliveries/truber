    ...
    <div class="container">
        <div class="intro-text">
            ...
            <form class="bootstrap-form-with-validation" action="signup.php" method="POST" onsubmit="return sendForm();">
                ...
                <div class="form-group"><label for="firstname">Firstname</label><input class="form-control" type="text" id="firstname" name="firstname" required></div>
                <div class="form-group"><label for="lastname">Lastname</label><input class="form-control" type="text" id="lastname" name="lastname" required></div>
