            ...
            <div class="row">
                ...
                <table id="example1" class="table table-bordered">
                    ...
                    try{
                        ...
                        $stmt = $conn->prepare("SELECT * FROM booking,invoice,status,customer WHERE booking.driver_id=invoice.driver_id 
                                                         AND booking.booking_status=status.id AND booking.driver_id=:driver_id AND customer.id=invoice.customer_id GROUP BY invoice_id");
